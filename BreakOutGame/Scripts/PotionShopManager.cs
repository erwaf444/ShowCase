...
public class PotionShopManager : MonoBehaviour
{
    ...
    public TextMeshProUGUI potionCollDownText;

    public Animator usePotionAnimator;
    public Animator usePotionAnimatorWithCoins;
    public Animator usePotionAnimatorWithHeart;
    public Animator usePotionAnimatorWithPaddleBig;
    public Animator usePotionAnimatorWithPaddleSmall;
    public Animator usePotionAnimatorWithAddBall;
    ...
    async void Start()
    {
        bouncyBallCoins.notEnoughCoins.SetActive(false);
